                ...
                <div className='mt-[30px] grid items-center gap-6 '>
                    <div className='max-sm:hidden max-lg:grid max-lg:grid-cols-8 max-lg:gap-2 lg:flex lg:justify-between '>
                        {listSelectShowDetail.map((list) => (
                            <>
                                <button key={list.id} className={`${isSelectDetail === list.id ? "font-bold before:left-0 before:w-full before:opacity-100 text-[#2B32B2] border-b-[3px] border-white" : " before:left-1/2 before:w-0  before:opacity-0 border-[1px] border-solid border-white/10 text-white/50"} text-lg bg-white/5 backdrop-blur-[10px shadow-lg px-[15px] py-[5px] rounded-[10px_10px_0_0]  backdrop-blur-[10px] max-lg:hidden group transiton-all duration-300 relative before:content-[""] before:absolute before:bg-white/30 before:backdrop-blur-[10px] before:shadow-lg before:rounded-[10px_10px_0_0] before:transition-all before:duration-300 before:top-0 before:h-full before:z-[-1] hover:before:left-0 hover:before:w-full hover:before:opacity-100 hover:text-[#2B32B2]`}
                                    onClick={() => {
                                ...
                                <button key={list.id} className={`${isSelectDetail === list.id ? "font-bold before:left-0 before:w-full before:opacity-100 text-[#2B32B2] border-b-[3px] border-white" : " before:left-1/2 before:w-0  before:opacity-0 border-[1px] border-solid border-white/10 text-white/50"} text-lg bg-white/5 backdrop-blur-[10px shadow-lg px-[15px] py-[10px] rounded-[10px_10px_0_0]  backdrop-blur-[10px] lg:hidden group transiton-all duration-300 relative before:content-[""] before:absolute before:bg-white/30 before:backdrop-blur-[10px] before:shadow-lg before:rounded-[10px_10px_0_0] before:transition-all before:duration-300 before:top-0 before:h-full before:z-[-1] hover:before:left-0 hover:before:w-full hover:before:opacity-100 hover:text-[#2B32B2]`}
                                    onClick={() => {
                                        setIsSelectDetail(list.id)
                                    }}
                                >
