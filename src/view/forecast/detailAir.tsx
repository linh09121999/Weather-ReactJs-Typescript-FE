  ...
  return (
    <div className='grid gap-6'>
      ...
      <div className='grid gap-4'>
        <p className='text-white text-xl font-bold max-sm:text-lg'>Giới thiệu về khí CO</p>
      ...
      <div className='grid gap-4'>
        <p className='text-white text-xl font-bold max-sm:text-lg'>Giới thiệu về khí NO2</p>
        <div className='p-[25px] max-sm:p-[15px] bg-white/5 border-[1px] border-solid border-white/10 backdrop-blur-[10px] shadow-lg rounded-[10px]'>
          <p className='text-white text-lg max-sm:text-sm'>
      ...
      <div className='grid gap-4'>
        <p className='text-white text-xl font-bold max-sm:text-lg'>Giới thiệu về khí O3</p>
        <div className='p-[25px] max-sm:p-[15px] bg-white/5 border-[1px] border-solid border-white/10 backdrop-blur-[10px] shadow-lg rounded-[10px]'>
          <p className='text-white text-lg max-sm:text-sm'>
      ...
      <div className='grid gap-4'>
        <p className='text-white text-xl font-bold max-sm:text-lg'>Giới thiệu về khí S02</p>
        <div className='p-[25px] max-sm:p-[15px] bg-white/5 border-[1px] border-solid border-white/10 backdrop-blur-[10px] shadow-lg rounded-[10px]'>
          <p className='text-white text-lg max-sm:text-sm'>
      ...
      <div className='grid gap-4'>
        <p className='text-white text-xl font-bold max-sm:text-lg'>Giới thiệu về khí MP2.5</p>
        <div className='p-[25px] max-sm:p-[15px] bg-white/5 border-[1px] border-solid border-white/10 backdrop-blur-[10px] shadow-lg rounded-[10px]'>
          <p className='text-white text-lg max-sm:text-sm'>
      ...
      <div className='grid gap-4'>
        <p className='text-white text-xl font-bold max-sm:text-lg'>Giới thiệu về khí MP10</p>
        <div className='p-[25px] max-sm:p-[15px] bg-white/5 border-[1px] border-solid border-white/10 backdrop-blur-[10px] shadow-lg rounded-[10px]'>
          <p className='text-white text-lg max-sm:text-sm'>
      ...
      <div className='grid gap-4'>
        <p className='text-white text-xl font-bold max-sm:text-lg'>Giới thiệu về chỉ số US-EPA</p>
        <div className='p-[25px] max-sm:p-[15px] bg-white/5 border-[1px] border-solid border-white/10 backdrop-blur-[10px] shadow-lg rounded-[10px]'>
          <p className='text-white text-lg max-sm:text-sm'>
      ...
      <div className='grid gap-4'>
        <p className='text-white text-xl font-bold max-sm:text-lg'>Giới thiệu về chỉ số GB-DEFRA</p>
        <div className='p-[25px] max-sm:p-[15px] bg-white/5 border-[1px] border-solid border-white/10 backdrop-blur-[10px] shadow-lg rounded-[10px]'>
          <p className='text-white text-lg max-sm:text-sm'>
