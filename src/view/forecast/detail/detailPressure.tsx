    ...
    return (
        <div className='grid gap-6'>
            <div className='w-full p-[25px] max-sm:p-[15px] bg-white/5 border-[1px] border-solid border-white/10 backdrop-blur-[10px] shadow-lg rounded-[10px]'>
                <ChartLineBase title="Áp suất" stepSize={5} minValue={960} maxValue={1050} currentIndex={isBorderDash} hours={hours} dataDetail={pressure} borderColor="white" backgroundColor="rgb(255,255,255,0.5)" donvi={isMobile ? "" : "hPa"} />
            </div>
