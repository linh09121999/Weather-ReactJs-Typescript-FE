                    ...
                    <div className='flex gap-2 justity-self-end'>
                        ...
                        >
                            <MenuItem sx={sxMenuItem}>
                                <div className='flex justify-between w-full items-center gap-10'>Nhiệt độ
                            ...
                            <MenuItem sx={sxMenuItem}>
                                <div className='flex justify-between w-full items-center gap-10'>Gió
                                    <div className='flex bg-white/5 rounded-[50px] backdrop-blur-[10px] border-[1px] border-solid border-white/10 px-[5px] py-[5px] shadow-lg'>
                            ...
                            <MenuItem sx={sxMenuItem}>
                                <div className='flex justify-between w-full items-center gap-10'>Lượng mưa
                                    <div className='flex bg-white/5 rounded-[50px] backdrop-blur-[10px] border-[1px] border-solid border-white/10 px-[5px] py-[5px] shadow-lg'>
                            ...
                            <MenuItem sx={sxMenuItem}>
                                <div className='flex justify-between w-full items-center gap-10'>Tầm Nhìn
                                    <div className='flex bg-white/5 rounded-[50px] backdrop-blur-[10px] border-[1px] border-solid border-white/10 px-[5px] py-[5px] shadow-lg'>
                            ...
                            <MenuItem sx={sxMenuItem}>
                                <div className='flex justify-between w-full items-center gap-10'>Áp Suất
                                    <div className='flex bg-white/5 rounded-[50px] backdrop-blur-[10px] border-[1px] border-solid border-white/10 px-[5px] py-[5px] shadow-lg'>
                            ...
                            <MenuItem sx={sxMenuItem}>
                                <div className='flex justify-between w-full items-center gap-10'>Tiêu chuẩn chất lượng không khí
                                    <div className='flex bg-white/5 rounded-[50px] backdrop-blur-[10px] border-[1px] border-solid border-white/10 px-[5px] py-[5px] shadow-lg'>
